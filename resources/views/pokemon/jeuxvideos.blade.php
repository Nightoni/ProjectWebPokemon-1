										...
										<div id="content">
											...
											<!-- Content -->
												...
												<article>
													<header class="major">
														<h3>20 nov. 2018</h3>
														<h2>Capturez Cresselia en Combats de Raids</h2>
														<p>Pokemon GO</p>
													</header>

													<span class="image featured"><img src="images/pokemongo-go-180.jpg" alt="" /></span>

													<p>Dresseurs, il est temps de passer du sinistre type Spectre au halo laiteux de l'astre lunaire. Le Pokémon Lunaire, Cresselia,
													 se jette dans la mêlée dans les Combats de Raids de Pokémon GO. Il est dit que ceux qui s'endorment en tenant une plume de Cresselia
													  feront de beaux rêves. Cependant ne vous reposez pas sur vos lauriers, ce type Psy ne sera disponible dans les Arènes que jusqu'au 18
													   décembre 2018 à 13h PST (UTC -8).
													</p>

													<h3>Pour une durée limitée, ce Pokémon légendaire de type Psy apparaît dans les Combats de Raids de Pokémon GO.</h3>
													<p>Profitez des faiblesses de son type pour maximiser les dégâts sur Cresselia. Les Pokémon de type Psy sont vulnérables aux attaques 
													de types Insecte, Spectre, et Ténèbres, donc utilisez ces types d'attaques avec vos meilleurs Pokémon. Entourez-vous de vos amis lorsque
													 vous défiez Cresselia. Vous pourriez gagner des Honor Balls en supplément, et vous aurez besoin de renforts pour mettre à bas ce Pokémon
													  légendaire puissant.Bonne chance, Dresseurs. Nous espérons que vous avez fait vos réserves de Pokémon effrayants pendant la période 
													  d'Halloween.</p>
												</article>
												<article>
													<header class="major">
														<h3>16 nov. 2018</h3>
														<h2>Découvrez Meltan et d’autres surprises dans Pokémon GO</h2>
														<p>Pokemon GO</p>
													</header>

													<span class="image featured"><img src="images/pokemongo-go-168.jpg" alt="" /></span>

													<p>Avec la sortie de Pokémon : Let's Go, Pikachu et Pokémon : Let's Go, Évoli sur Nintendo Switch, les joueurs ont l'occasion de rencontrer 
													pour la première fois le Pokémon fabuleux Meltan. Le Professeur Willow a commencé à solliciter de l'aide dans une nouvelle Étude spéciale
													... alors sortez vous promener et recueillez des informations sur ce mystérieux Pokémon de type Acier.</p>

													<h3>Des bonus spéciaux variés apparaîtront dans Pokémon GO pour célébrer la sortie de Pokémon : Let’s Go, Pikachu et Pokémon : Let’s Go, Évoli.</h3>
													<p>Non seulement vous pouvez trouver Meltan en participant à une Étude spéciale, mais il est également possible de découvrir des Pokémon rares 
													dans Pokémon GO et de les transférer vers les nouveaux jeux sur Nintendo Switch. À partir du 27 novembre 2018, de nouvelles Études de terrain 
													présenteront des Pokémon découverts dans la région de Kanto rarement vus dans Pokémon : Let's Go, Pikachu et Pokémon : Let's Go, Évoli. Au 
													même moment, des Pokémon tels qu'Amonita et Kabuto pourraient également apparaître plus fréquemment.</p>
													<p>Finalement, du 23 novembre à 13h PST (UTC -8) au 26 novembre à 13h PST (UTC -8), les formes évoluées des deux Pokémon en vedette dans les 
													nouveaux jeux pour la Nintendo Switch apparaîtront dans les Combats de Raids. Pendant cette période, guettez certaines Évolutions d'Évoli, telles
													 qu'Aquali, Voltali, Pyroli, Mentali et Noctali, ainsi que Raichu et sa forme d'Alola.</p>
												</article>
